...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRABATH-MD~pmFDEZxC#HyWb59dvECirNAe_-krh8uQhgShDQa4NMf2X8ayMurY",
BOT_NUMBER: process.env.BOT_NUMBER || "2349151066117",
PASSWORD: process.env.PASSWORD || "@Adeileri#6859!",
GITHUB_USERNAME: process.env.GITHUB_USERNAME || "Oreofe-ilerioluwa",
